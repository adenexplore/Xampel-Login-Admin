    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" #" target="_blank">
                ...
                <span class="ms-1 font-weight-bold">Aplikasi 2025</span>
            </a>
        </div>
        ...
        <div class="sidenav-footer mx-3 ">
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                <div class="full-background"
                    style="background-image: url('https://cdn.pixabay.com/photo/2017/05/05/23/39/whatsapp-2288548_1280.png')">
                </div>
                <div class="card-body text-start p-3 w-100">
                    ...
                    <div class="docs-info">
                        ...
                        <p class="text-xs font-weight-bold">Please whatsapp</p>
                        <a href="#" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Whatsapp</a>
                    </div>
                </div>
            </div>
            <a class="btn btn-primary mt-3 w-100" href="#" id="logoutButton">
                <i class="fas fa-sign-out-alt mr-2"></i> Logout
            </a>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a class="btn btn-outline-primary btn-sm mb-0 me-3" id="userDropdown"
                        ...
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                               ...
                               Copyright <i class="fa fa-heart"></i> by
                                <a href="https://adenrifai.com" class="font-weight-bold" target="_blank">Aden Rifai</a>
                            </div>
                        </div>
                        <!-- <div class="col-lg-6">
        ...
        <div class="card shadow-lg ">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start">
                    <h5 class="mt-3 mb-0">Aplikasi 2024</h5>
